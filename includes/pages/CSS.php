<div class="content">
    ...
    <a href="https://developer.mozilla.org/ru/docs/Web/HTML" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i>&NonBreakingSpace;Mozilla</a>
    ...
    <ul>
        ...
        <li>
            <i class="fa fa-check-circle-o" aria-hidden="true"></i>&NonBreakingSpace;Подключить с Google fonts любой на ваш выбор
        </li>
        <li>
            <i class="fa fa-check-circle-o" aria-hidden="true"></i>&NonBreakingSpace;Сделать (На ваш вкус):
            <ul>
                <li>
                    <i class="fa fa-check" aria-hidden="true"></i>&NonBreakingSpace;Хедер(логотип, меню с ссылками, и ссылка Contact us)
                </li>
                <li>
                    <i class="fa fa-check" aria-hidden="true"></i>&NonBreakingSpace;Боди (обычные текстовые поля, картинки и заголовки)
                </li>
                <li>
                    <i class="fa fa-check" aria-hidden="true"></i>&NonBreakingSpace;Футер(Копирайт и логотипы соц сетей)
                </li>
            </ul>
        </li>
    </ul>
    ...
    <a href="https://html5book.ru/html-table/" target="_blank"><i class="fa fa-arrow-right" aria-hidden="true"></i>&NonBreakingSpace;Html5book</a>
    ...
    <ul>
        ...
        <li>
            <i class="fa fa-check-circle-o" aria-hidden="true"></i>&NonBreakingSpace;Добавить таблицу которая будет нести в себе (thead, tbody, tfoot) - попробовать объединить колонки друг с другом
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <i class="fa fa-check" aria-hidden="true"></i>&NonBreakingSpace;Password (Обязательное, должно содержать только пароль, минимум 8 символов)
                </li>
            </ul>
        </li>
        <li>
...
@import url('https://fonts.googleapis.com/css2?family=Quicksand&display=swap');</pre>
    ...
    <table>
        ...
        <thead>
        <tr>
            <th scope="col">Left column header</th>
            <th scope="col">Middle column header</th>
            <th scope="col">Right column header</th>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            <th scope="row" colspan="2">1 b + 2 b</th>
            <td rowspan="2">3 b + 3 c</td>
        </tr>
        <tr>
            <th scope="row">1 c </th>
            <td>2 c </td>
